...
class Page {
    constructor(){
        this.sName = "Simrit Dhillon";
        this.sUrlToEmailer = "https://ancient-chamber-84861.herokuapp.com/send/";
    ...
    render(){
        ...
        for(let n = 0; n < this.oItems.length; n++){
            if(n != this.nCurrentItem){
                ...
                <div class="item">
                    <a class="itemLink" href="#"><img id="item${n}" src="${this.getImageSrc(this.oItems[n].specialImage)}" alt="${this.getImageSrc(this.oItems[n].specialImage)}"/></a>
